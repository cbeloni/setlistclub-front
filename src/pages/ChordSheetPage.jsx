  ...
  return (
    <article className="space-y-6 animate-fade-in">
      ...
      <header className="relative overflow-hidden panel p-8">
        <div className="pointer-events-none absolute -right-8 -top-8 h-40 w-40 rounded-full bg-green-500/8 blur-2xl" />
        <span className="label-section">Cifra Pública</span>
        <h2 className="mt-3 text-4xl font-black text-green-50">{chordSheet.title}</h2>
        <p className="mt-1 text-base font-medium text-green-400">{chordSheet.artist}</p>
      ...
      <div className="panel p-6">
        <h3 className="text-sm font-semibold text-green-400 uppercase tracking-widest mb-4">
          Cifra
        </h3>
        <pre className="overflow-x-auto whitespace-pre-wrap font-mono text-sm leading-8 text-green-100/90">
          {chordSheet.content}
        </pre>
      </div>
    </article>
